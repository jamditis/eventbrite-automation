...
def test_raises_when_configured_org_missing(monkeypatch):
    ...
    _stub_orgs(monkeypatch, {"organizations": [{"id": BLANK_ORG, "name": ""}]})
    client = EventbriteClient()
